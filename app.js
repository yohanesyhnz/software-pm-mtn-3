...
const DEFAULT_SEED_DATA = {
  users: [
    { id: 1, username: 'admin', password: 'admin123', role: 'ADMIN', full_name: 'Danko Ariyanto' },
    { id: 2, username: 'yohanes', password: 'Yhnz_123', role: 'SUPERVISOR', full_name: 'Yohanes Ariyanto' },
    { id: 3, username: 'BAR', password: 'BAR123', role: 'TECHNICIAN', full_name: 'BAR' },
    { id: 4, username: 'YAO', password: 'Yhnz_123', role: 'ADMIN', full_name: 'YAO Admin' }
  ],
  machines: [
...
function performDesktopLogin() {
  ...
  const isMatch = (password === user.password) ||
                  (user.role === 'ADMIN' && (password === 'admin123' || password === 'Yhnz_123')) ||
                  (user.role === 'SUPERVISOR' && (password === 'spv123')) ||
                  (user.role === 'TECHNICIAN' && (password === 'tech123'));
...
function mobileLogin() {
  ...
  if (matched) {
    ...
    alert(`Login Gagal: Username "${user}" atau Password/PIN salah.\n\nContoh Akun:\n- User: BAR, PIN: BAR123\n- User: yohanes, PIN: Yhnz_123\n- User: tech, PIN: tech123`);
  }
}
...
function confirmSecureReset() {
  ...
  const isValidPassword = (password === authUser.password) || 
                          (authUser.role === 'ADMIN' && (password === 'admin123' || password === 'Yhnz_123')) ||
                          (authUser.role === 'SUPERVISOR' && (password === 'spv123'));
